...
from utils import (
    calculate_comorbidity_score,
    estimate_glucose_from_diabetes,
    map_comorbidity_to_realistic_values,
    predict_readmission,
    calculate_risk_score_from_factors
)
...
# 20. Backend process when someone accesses the frontend.
...
def get_summary():
# 21. GET api. This is where the inputs are stored.
...
def health_check():
# 22. Health check only for previous cell.
